...
function App() {
  ...
  //Loads the data once the application has been initialized
  useEffect(() => {
  ...
  // In JSX, you only return one element from each component
  return (
    // A fragment is basically just a JSX element, which will not produce any HTML output.
    <>
